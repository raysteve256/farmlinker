...
export default function Suppliers({ me, suppliers, onAdd, onContact, modalOpen, onCloseModal, onToast }) {
  ...
  const items = suppliers.filter(s => filter === 'all' || s.category === filter)
  ...
  return (
    <div className="screen">
      ...
      {items.length === 0 && <div className="empty"><span className="glyph">🧰</span><p><strong>No suppliers yet</strong><br />Suppliers in your district will appear here.</p></div>}
      {items.map(s => {
